...
public class Blue3ScoreLeftManual extends SequentialCommandGroup{
    ...
    public static CommandBase followTrajectoryCommand(Swerve swerve, Elevator elevator, Slider slider, Wrist wrist, Hand hand) {
        ...
        return new SequentialCommandGroup(
            ...
            new ParallelCommandGroup(
                new DriveToPosition(s_Swerve, new Pose2d(new Translation2d(-163.384, 52.33), new Rotation2d(0)), 1.6), //-7.33 is not final.
                ToGroundAutoCube.getToGround(elevator, slider, wrist)),
            /* drive to pickup piece. */
            new ParallelRaceGroup(
                new DriveToPosition(s_Swerve, new Pose2d(new Translation2d(-214.133, 52.33), new Rotation2d(0)), 1.4),
                new Outtake(hand)
            ),
            /* drive back to score. */
