...
public class Blue2ScoreRightManual extends SequentialCommandGroup{
    ...
    public static CommandBase followTrajectoryCommand(Swerve swerve, Elevator elevator, Slider slider, Wrist wrist, Hand hand) {
        ...
        return new SequentialCommandGroup(
            new IntakeAuto(hand),
            new DriveToPosition(s_Swerve, new Pose2d(new Translation2d(-43.307, 13.38), new Rotation2d(0)), 1.2),
            new DriveToPosition(s_Swerve, new Pose2d(new Translation2d(-111.417, 13.38), new Rotation2d(0)), 1.7),
            new TurnAndMove(s_Swerve, new Pose2d(new Translation2d(-163.384, 4.33), new Rotation2d(0)), 0, 2.4),
            ToGround.getToGround(elevator, slider, wrist),
            new ParallelRaceGroup(
                new DriveToPosition(s_Swerve, new Pose2d(new Translation2d(-214.133, 4.33), new Rotation2d(0)), 2.4),
                new Outtake(hand)
            ),
            Stow.getStowCommand(elevator, slider, wrist),
            new TurnAndMove(s_Swerve, new Pose2d(new Translation2d(-163.384, 4.33), new Rotation2d(0)), 179, 2.4),
            new DriveToPosition(s_Swerve, new Pose2d(new Translation2d(-111.417, 13.38), new Rotation2d(0)), 1.7),
            new DriveToPosition(s_Swerve, new Pose2d(new Translation2d(-43.307, 13.38), new Rotation2d(0)), 1.2),
            new DriveToPosition(s_Swerve, new Pose2d(new Translation2d(0, 0), new Rotation2d(0)), 1.2),
            new IntakeAuto(hand)
            );
    }
}
