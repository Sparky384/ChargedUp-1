...
public class Blue2ScoreRightRampAuto extends SequentialCommandGroup{
    ...
    public static CommandBase followTrajectoryCommand(Swerve swerve, Elevator elevator, Slider slider, Wrist wrist, Hand hand) {
        ...
        return new SequentialCommandGroup(
            ...
            */
            ...
            //should be able to import Blue2ScoreRight however just going to keep code above for now.

            Blue2ScoreRightRamp.followTrajectoryCommand(false, s_Swerve),
            // for final. Purpose is to put wrist down before we get to the end in an attempt to save as much time as possible.
            new ParallelCommandGroup(Blue2ScoreRightScore.followTrajectoryCommand(false, s_Swerve), Stow.getStowCommand(s_Elevator, s_Slider, s_Wrist))
        );
    }
}
