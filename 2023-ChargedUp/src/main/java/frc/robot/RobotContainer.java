...
public class RobotContainer {
    ...
    /* Driver Buttons */
    private final JoystickButton zeroPigeon = new JoystickButton(driver, XboxController.Button.kY.value);
    ...
    private void configureButtonBindings() {
        /* Driver Buttons */
        zeroPigeon.onTrue(new InstantCommand(() -> s_Swerve.zeroPigeon()));
    }
