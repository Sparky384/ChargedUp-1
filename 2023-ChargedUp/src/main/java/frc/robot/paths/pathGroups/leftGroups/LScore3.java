...
public class LScore3 extends SequentialCommandGroup {
    ...
    public static CommandBase followTrajectoryCommand(Swerve swerve, Elevator elevator, Slider slider, Wrist wrist, Hand hand) {
        ...
        LScore2.followTrajectoryCommand(s_Swerve, s_Elevator, s_Slider, s_Wrist, s_Hand),
        
        /* Prime elevator for picking up 3rd object and move to 3rd object. */
        new ParallelCommandGroup(new MoveElevator(s_Elevator, Constants.Subsys.elevatorLow), LPickup3rd.followTrajectoryCommand(false, s_Swerve)),
        ...
        new ParallelCommandGroup(new MoveElevator(s_Elevator, Constants.Subsys.elevatorHigh), LScore3rd.followTrajectoryCommand(false, s_Swerve)),
