...
public class Ultimate_5 extends SequentialCommandGroup{
    private static Swerve s_Swerve;

    static PathPlannerTrajectory exampleTrajectory = PathPlanner.loadPath("Auto11_5", new PathConstraints(Constants.AutoConstants.kPathMaxVelocity, Constants.AutoConstants.kPathMaxAcceleration));
