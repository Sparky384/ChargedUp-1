...
import frc.robot.paths.leftPaths.LRampFinal;
...
public class LUltimate extends SequentialCommandGroup{
    ...
    public static CommandBase followTrajectoryCommand(Swerve swerve, Elevator elevator, Slider slider, Wrist wrist, Hand hand) {
        ...
        /* after RScore3: Elevator up, sliderIn, WristHigh */
        LScore3.followTrajectoryCommand(s_Swerve, s_Elevator, s_Slider, s_Wrist, s_Hand),

        /* Put elevator down and move towards ramp */
        new ParallelCommandGroup(new MoveElevator(s_Elevator, Constants.Subsys.elevatorLow), LRampFinal.followTrajectoryCommand(false, s_Swerve)),
