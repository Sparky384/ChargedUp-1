...
public class Ultimate_2 extends SequentialCommandGroup{
    private static Swerve s_Swerve;

    static PathPlannerTrajectory exampleTrajectory = PathPlanner.loadPath("Auto11_2", new PathConstraints(Constants.AutoConstants.kPathMaxVelocity, Constants.AutoConstants.kPathMaxAcceleration));
