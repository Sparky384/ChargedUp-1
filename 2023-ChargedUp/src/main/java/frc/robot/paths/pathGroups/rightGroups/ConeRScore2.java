...
import frc.robot.paths.rightPaths.ConeRPickup2nd;
import frc.robot.paths.rightPaths.ConeRScore2nd;
...
public class ConeRScore2 extends SequentialCommandGroup {
    ...
    public static CommandBase followTrajectoryCommand(Swerve swerve, Elevator elevator, Slider slider, Wrist wrist, Hand hand) {
        ...
        return new SequentialCommandGroup(
            ...
            ConeRScore2nd.followTrajectoryCommand(false, s_Swerve),
            ToHigh.getToHigh(s_Elevator, s_Slider, wrist),
            new OuttakeAuto(s_Hand)
        );
    }
