...
public class Blue3ScoreRightScore extends SequentialCommandGroup {
    private static Swerve s_Swerve;

    static PathPlannerTrajectory trajectory = PathPlanner.loadPath("Blue3ScoreRightScore", new PathConstraints(Constants.AutoConstants.kPathMaxVelocity, Constants.AutoConstants.kPathMaxAcceleration));
