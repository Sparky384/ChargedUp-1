...
public class JustDriveAuto extends SequentialCommandGroup {
    ...
    static PathPlannerTrajectory exampleTrajectory = PathPlanner.loadPath("justDrive", new PathConstraints(Constants.AutoConstants.kPathMaxVelocity, Constants.AutoConstants.kPathMaxAcceleration));
